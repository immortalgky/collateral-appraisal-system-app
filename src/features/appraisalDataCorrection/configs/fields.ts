...
// buildingArea (totalBuildingArea) intentionally removed — see the Building Detail section
// in forms/BuildingDetailForm.tsx. Area feeds the RCN and depreciation figures, which this
// screen does not recompute.
