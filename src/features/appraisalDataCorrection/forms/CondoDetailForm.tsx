...
import { PropertyNameTriggerIcon } from '@/features/appraisal/components/PropertyNameTriggerIcon';
...
function CondoDetailForm() {
  ...
  // The create screen recomputes governmentPrice from pricePerSqm × usableArea here. Dropped:
  // usableArea is not correctable on this screen, so all the effect could do is overwrite a
  // stored price with one derived from a value the admin can neither see nor change.
