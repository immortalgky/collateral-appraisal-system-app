...
const LandDetailForm = ({ propertyType = 'L' }: LandDetailFormProps) => {
  ...
  return (
    <div className="w-full max-w-full overflow-hidden">
      {/* The create screen prints "Land Detail" here. Dropped: this screen already puts a
          "Land Information" group header above the form, so it was the same heading twice. */}
