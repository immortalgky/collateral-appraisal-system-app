...
/**
 * Removable filter tags shown under the report filter bar. A local copy of the monitoring feature's
 * component (kept here so the reports feature doesn't depend on the monitoring i18n namespace).
 */
