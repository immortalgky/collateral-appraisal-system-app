 ...
 */
export function useGetFollowupByWorkflowInstance(followupWorkflowInstanceId: string | undefined) {
  return useQuery({
    queryKey: followupKeys.byWorkflowInstance(followupWorkflowInstanceId ?? ''),
    queryFn: () => getFollowupByWorkflowInstanceId(followupWorkflowInstanceId!),
