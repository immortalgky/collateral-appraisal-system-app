    ...
    <div className="flex flex-col h-full min-h-0 gap-3">
      ...
      <div className="shrink-0 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">Manage and track your company's invoices</p>
        </div>
              ...
              {isFirstLoad ? (
                  ...
                  <td colSpan={9} className="text-center py-16">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-xs text-gray-400">
                        {hasFilters ? 'Try different filters' : 'Create your first invoice'}
                      </p>
                    </div>
                  </td>
                </tr>
                ...
                items.map(item => (
                  <tr key={item.id} className="hover:bg-gray-50 even:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-4 py-2.5 text-gray-700">{item.companyName ?? '—'}</td>
                    <td className="px-4 py-2.5">
