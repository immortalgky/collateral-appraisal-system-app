    ...
    <IsCalculatingProvider value={isCalculating ?? false}>
      ...
      */}
        ...
        <SectionPrimary id="hyp-section-revenue" title="Project Revenue Estimates">
          ...
          <PdcTotalRow
            label="Total Project Revenue Estimates (Total of GDV)"
        ...
        <SectionPrimary
          id="hyp-section-hard"
          title="Estimate building construction costs and project development costs (Hard Cost)"
        >
          <PdcDerivedRow
        ...
        <SectionPrimary title="Estimate The Project Construction Period">
          <FieldRow
            label="Estimated Construction Duration"
            tooltip={CONDO_TIPS.estConstructionPeriod}
          >
            <div className="flex items-center gap-2 ml-auto flex-wrap">
              <InlineNumberInput
                control={control}
        ...
        <SectionPrimary id="hyp-section-soft" title="Project Cost Estimation (Soft Cost)">
          ...
          <PdcDerivedRow
            ...
            rateInput={<InlineNumberInput control={control} name="summary.titleDeedFee" fillSlot />}
            rateUnit="Baht"
          ...
          <PdcDerivedRow
            ...
            rateInput={<InlineNumberInput control={control} name="summary.eiaCost" fillSlot />}
            rateUnit="Baht"
        ...
        <SectionPrimary
          id="hyp-section-total-dev"
          title="Total Project Development Costs and Expenses"
        >
          <PdcTotalRow
        ...
        <SectionPrimary id="hyp-section-final" title="Total Remaining Value of All Assets in Cash">
          ...
          <FvDerivedRow
            ...
            tooltip={CONDO_TIPS.discountRateFactor}
